  ...
  return (
    <AppShell>
      <div className="relative h-screen flex flex-col overflow-hidden">
        ...
        {/* Main Content — pushed down, synced with bottom bar */}
              ...
              >
                <div
                  className={`absolute top-[2px] w-[14px] h-[14px] rounded-full shadow-sm transition-all duration-200 ${
                    multiShot ? 'left-[14px] bg-white' : 'left-[2px] bg-white'
                  }`}
                />
              </div>
            </div>
        ...
        {/* Bottom Prompt Bar — has its own model, duration, aspect, enhance, sound controls */}
        <VideoPromptBar />
      </div>
    </AppShell>
  );
